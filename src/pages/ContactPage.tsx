...
export const ContactPage: React.FC = () => {
  ...
  const validate = () => {
    ...
    if (!formData.service) newErrors.service = 'Please select a primary service required';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
            ...
            <div className="lg:col-span-7">
              <div className="bg-white border-2 border-border p-8 sm:p-10 rounded-sm shadow-card">
                
                <div className="mb-8">
                  <div className="inline-flex items-center gap-1.5 px-3 py-1 mb-2 text-xs font-bold uppercase tracking-[0.2em] rounded-sm bg-navy/10 text-navy">
                    <FileCheck className="w-4 h-4 text-gold" />
                    <span>Project Enquiry Form</span>
                  </div>
                  <h2 className="text-2xl sm:text-3xl font-extrabold uppercase text-navy font-heading">
                    Request a Technical Proposal
                  </h2>
                  <p className="text-slate text-sm mt-1">
                    Fill in your project parameters below and our engineering team will respond within 24 business hours.
                  </p>
                </div>

                {isSuccess ? (
                  <div className="p-8 rounded-sm bg-navy-dark text-white border border-gold/40 text-center animate-in fade-in zoom-in duration-300 space-y-4">
                    ...
                    <p className="text-gray-300 text-sm max-w-md mx-auto leading-relaxed">
                      Thank you for contacting Sai Jagannath Engineering &amp; Construction. Your project details have been logged and assigned to our Project Management team.
                    </p>
                    <button
                      type="button"
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5" noValidate>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                      ...
                      <div>
                        <label htmlFor="company" className="block text-xs font-bold uppercase tracking-wider text-navy mb-1.5">
                          Company / Organization <span className="text-slate/60 text-[10px] lowercase">(optional)</span>
                        </label>
                        <input
                          type="text"
                          id="company"
                          ...
                          onChange={handleChange}
                          placeholder="e.g. Steel / Cement Corp Ltd"
                          className="w-full px-4 py-3 text-sm rounded-sm border border-border bg-offwhite focus:border-gold focus:bg-white focus:outline-none transition-colors"
                        />
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        onChange={handleChange}
                        placeholder="Please include plant type, capacity, location, estimated schedule, or specific equipment requirements (e.g. HT/LT panels, cable laying, Robo Lab, transformer erection)."
                        className={`w-full px-4 py-3 text-sm rounded-sm border ${
                    ...
                    <div className="pt-3">
                      <button
                        ...
                        className="w-full btn-gold py-4 text-sm font-bold uppercase tracking-wider flex items-center justify-center gap-2 group disabled:opacity-70 shadow-lg"
                      >
                        {isSubmitting ? (
                          <>
                    ...
                    <div className="text-[11px] text-slate text-center pt-2">
                      <ShieldCheck className="w-3.5 h-3.5 inline text-gold mr-1" />
                      Your project information is held in strict commercial confidence.
                    </div>
            ...
            <div className="lg:col-span-5 space-y-8">
              ...
              {/* Office Contact Card */}
              <div className="bg-navy-dark text-white p-8 rounded-sm border border-border-navy shadow-xl space-y-6">
                <div className="border-b border-navy-light/30 pb-4">
                  <span className="text-xs font-bold uppercase tracking-[0.2em] text-gold">Public Verified Office</span>
                  <h3 className="text-xl font-extrabold uppercase text-white font-heading mt-1">
                    Corporate Contact
                  </h3>
                </div>
                ...
                <div className="space-y-4 text-sm text-gray-200">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <div className="text-xs text-gold uppercase font-bold">Registered Office</div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <div className="text-xs text-gold uppercase font-bold">Official Email</div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <div className="text-xs text-gold uppercase font-bold">Telephone (Office)</div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <div className="text-xs text-gold uppercase font-bold">Business Hours</div>
                      <p className="mt-0.5 text-xs text-gray-300">{COMPANY_INFO.contact.workingHours}</p>
                      <p className="text-[11px] text-gold mt-1">{COMPANY_INFO.contact.emergencySupport}</p>
                    </div>
                  </div>
                </div>

                <div className="p-4 bg-navy-surface rounded-sm border border-navy-light/30 text-xs text-gray-300">
                  <div className="font-bold text-white uppercase mb-1">Execution Footprint</div>
                  Active site deployment capabilities across Odisha, Jharkhand, West Bengal, and industrial corridors across India.
                </div>
              </div>

              {/* Verified Public Credentials Card */}
              <div className="bg-offwhite p-6 rounded-sm border border-border space-y-3">
                ...
                <div className="text-xs text-slate space-y-1.5">
                  <div className="flex justify-between border-b border-border-light pb-1">
                    ...
                    <span>Sai Jagannath Engineering &amp; Construction</span>
                  </div>
                  <div className="flex justify-between border-b border-border-light pb-1">
                    <span className="font-semibold text-charcoal">Foundational Inception:</span>
                    <span>2005 (M/S Sri Jagannath)</span>
                  </div>
                  <div className="flex justify-between border-b border-border-light pb-1">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-right max-w-[200px]">Industrial Electrical &amp; Instrumentation</span>
                  </div>
                </div>
              </div>
