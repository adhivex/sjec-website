...
export const INDUSTRIES: Industry[] = [
  {
    ...
    slug: "cement-plants",
    title: "Cement Plants",
    subtitle: "Integrated Plants, Clinker Units & Grinding Units (OGU)",
    description: "Extensive experience in mega cement plants and grinding units across Odisha and eastern India, executing electrical installations for raw mills, kilns, preheaters, cement grinding VRMs, packing plants, and silos.",
    keyExecutionFocus: [
      "Complete Robo Lab erection for automated quality control",
      "Vertical Roller Mill (VRM) main drive and auxiliary electricals",
      "Cement silo, baghouse, and material handling cable routing",
      "High mast illumination towers and plant-wide street lighting"
    ],
    typicalScope: [
      "HT/LT panel and drive commissioning for 2,000 to 4,500+ TPD units",
      "Instrumentation impulse piping and temperature/pressure loop validation",
  ...
  },
  {
    id: "process-plants",
    slug: "process-plants",
    title: "DRI / Process Plants",
    subtitle: "Direct Reduced Iron (Sponge Iron) & Chemical Process Facilities",
    description: "Specialized in Sponge Iron (DRI) rotary kiln electricals, cooler drives, off-gas handling, electro-static precipitators (ESP), and continuous process monitoring instrumentation.",
    keyExecutionFocus: [
      "Rotary kiln main drive, auxiliary diesel engine, and emergency drive electricals",
      "ESP transformer-rectifier (TR) set cabling and high-voltage control panels",
      "Off-gas and waste heat recovery boiler (WHRB) instrumentation",
      "Raw material feeding and de-dusting system electrical execution"
    ],
    typicalScope: [
      "500 TPD DRI kiln electrification and instrumentation turnkey scope",
      "MCC panel room installation, busbar trunking, and feeder cabling",
